...
export default function Home({ places }) {
    ...
    return (
        <main className="flex flex-col h-screen items-center">
            <nav className="bg-green-600 w-full text-white mb-20">
                <div className="container w-full text-white flex p-2 items-center">
                    <img src="/vaccination.png" className="w-8 mr-2" />
                    <span className="navbar-brand mb-0 h1 text-white text-3xl">COVID APP</span>
                </div>
            </nav>
            <div className="p-8">
            <h1 className="text-3xl">Vacination Form</h1>
            <h1 className="text-red-500">{message}</h1>
            <div className="flex flex-row gap-x-2">
                <input type="text" placeholder="city" value={city} onChange={(e) => setCity(e.target.value)} className="p-2 bg-gray-300 outline-none" />
                <input type="text" placeholder="name" value={name} onChange={(e) => setName(e.target.value)} className="p-2 bg-gray-300 outline-none" />
                ...
                <input type="text" placeholder="timings" value={timings} onChange={(e) => setTimings(e.target.value)} className="p-2 bg-gray-300 outline-none" />
                <button className="bg-green-500 p-2" onClick={() => addCentre()}>add</button>
            </div>

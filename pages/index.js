      ...
      <div className="text-center">
        ...
        <div className="flex flex-row gap-x-4">
          <div className="flex flex-col w-max gap-y-4 mt-4 border border-gray-300 p-8">
            ...
            <Link href={(email != "" && password != "") ? "/home" : "#"} ><button className="bg-green-500 p-2 w-full">Login</button></Link>
          </div>
          <div className="flex flex-col w-max gap-y-4 mt-4 border border-gray-300 p-8">
            ...
            <Link href={(aemail != "" && apassword != "") ? "/admin" : "#"} ><button className="bg-green-500 p-2 w-full">Login</button></Link>
          </div>
        </div>
      </div>
    </main>
